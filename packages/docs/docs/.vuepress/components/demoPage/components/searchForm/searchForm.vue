...
export default {
    ...
    methods: {
        ...
        onCustomEmitEvent (params) {
            // console.log('searchForm onCustomEmitEvent params = ', params)
            if (params.emitEvent === 'inputSearchFieldSearch') {
                this.onInputFieldSearch(params)
            } else if (params.emitEvent === 'inputFieldEnter') {
